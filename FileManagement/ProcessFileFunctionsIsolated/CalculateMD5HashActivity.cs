...
public class CalculateMD5Hash
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        {
            //logger.LogError(ex, $"Failed to calculate MD5 hash of the file with FileId: {parameters.FileId}, FileName: {parameters.FileName}");
            throw;
        }
    }
}